...
png(filename="c:/rdatas/file03.png", width = 480, height = 480)
...
legend("topright", null, c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col = c("black", "red", "blue"), text.col = c("black", "red", "blue"), lty = c(1, 1, 1))
dev.off()
